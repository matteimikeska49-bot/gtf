export const faqSchemaData = {
  ...
  "/blog/ai-instagram-carousel-generator": [
    ...
    { q: 'How do you create an Instagram carousel with AI?', a: 'Start with a clear topic, link, video, article, or rough idea. Define the audience and goal, generate hook options, build a slide-by-slide structure, write short slide copy, choose a visual direction, create a draft, and review it on mobile before publishing.' },
    ...
    { q: 'Is ChatGPT enough to make Instagram carousels?', a: 'ChatGPT can help with ideas, hooks, outlines, and slide copy. But by itself, it does not give you a complete visual carousel workflow. You still need to structure the slides, choose the visual direction, design the carousel, and refine the final draft.' },
    ...
    { q: 'Can I create an Instagram carousel with AI for free?', a: 'Some AI carousel tools offer free plans, trials, or limited free generations. The right choice depends on what you need: basic slide text, templates, visual drafts, brand styling, exports, or a full carousel workflow.' },
