...
const textToCarouselDraftPage = {
  ...
  templateCategories: [
    {
      title: 'Статьи и блог-посты',
      body: 'Сожмите длинный материал до ключевых тезисов для соцсетей.',
    },
    {
      title: 'Личные заметки',
      body: 'Соберите разрозненные мысли и наброски в структурированный гайд.',
    },
    {
      title: 'PDF и длинные документы',
      body: 'Используйте PDF или длинный текст как источник для будущей серии слайдов.',
    },
    {
      title: 'Инструкции и руководства',
      body: 'Разложите пошаговый процесс на карточки, где каждый шаг читается отдельно.',
    },
    {
      title: 'Чек-листы и списки',
      body: 'Преобразуйте пункты проверки, подборки или списки инструментов в сохраняемый формат.',
    },
    {
      title: 'Посты и рассылки',
      body: 'Переупакуйте длинный пост или письмо в короткую последовательность слайдов.',
    },
    {
      title: 'Сценарии и конспекты',
      body: 'Выделите ключевые идеи из сценария, вебинарного плана или конспекта.',
    },
    {
