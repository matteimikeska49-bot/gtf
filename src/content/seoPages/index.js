...
const textToCarouselFaq = [
  ...
  },
  {
    ...
    answer: 'Вы можете вставить обычный текст, скопировать ссылку на статью, скопировать текст из PDF-файла, добавить ссылку на YouTube-видео или использовать голосовое сообщение.',
  },
  {
...
const textToCarouselDraftPage = {
  ...
  secondaryKeywords: ['текст в карусель нейросеть', 'создать карусель из текста', 'создать карусель из текста для Instagram', 'статья в карусель'],
  ...
  templateCategories: [
    ...
    },
    {
      ...
      body: 'Вручную скопируйте нужный текст из PDF или используйте объёмный текст как источник для будущей серии слайдов.',
    },
    {
    ...
    groups: [
      {
        ...
        body: 'Прямая вставка текста, вручную скопированный текст из PDF или ссылка на статью.',
...
const canvaContractSpec = {
    ...
    choiceGuide: {
      ...
      description: "Создавайте карусели с помощью ИИ, используйте готовые шаблоны, собирайте бесшовные композиции или добавляйте анимацию. Из чего можно создать карусель: начните с собственной темы или добавьте готовый текст, заметки, ссылку, вручную скопированный текст из PDF, аудио или видео — в зависимости от поддерживаемого сценария GoToFlow.",
      items: [
        {
          task: "СОЗДАНИЕ С ПОМОЩЬЮ ИИ",
          template: "ИИ-карусель",
...
const photoToCarouselContractSpec = {
  ...
  contractTitle: 'Создать карусель из фото и изображений | GoToFlow',
  title: 'Создать карусель из фото и изображений | GoToFlow',
  description: 'Добавьте свои фото, изображения или скриншоты и соберите из них карусель в GoToFlow: структура, текст, визуальная логика, CTA и готовые слайды.',
  h1: 'Создать карусель из фото и изображений',
  breadcrumb: 'Фото в карусель',
  primaryKeyword: 'создать карусель из фото',
  secondaryKeywords: [
    'создать карусель из фото для instagram',
    'нейросеть для создания карусели из фото',
    'фото в карусель',
    'изображение в карусель',
  ],
  heroEyebrow: 'ФОТО В КАРУСЕЛЬ',
  heroHighlightFragment: 'фото и изображений',
  heroSubtitle: 'GoToFlow помогает превратить свои фото, изображения или скриншоты в понятную пост-карусель: добавить структуру, текстовые акценты, визуальную подачу и CTA без ручной сборки каждого слайда.',
  ctaLabel: 'Создать карусель из фото',
  secondaryCtaLabel: 'Смотреть сценарии',
  quickAnswer: {
    title: 'Как создать карусель из своих фото',
    body: 'Добавьте фото, изображение или скриншот как исходный материал. GoToFlow помогает собрать из него карусель: определить структуру, распределить смысл по слайдам, добавить текстовые акценты, визуальную логику и CTA. Это не страница про нарезку панорамы: бесшовная карусель остается отдельным сценарием.',
  },
  formatsHeading: {
    before: 'Какие фото-сценарии ',
    accent: 'можно собрать',
    after: ' в GoToFlow',
  },
  formats: [
    {
      title: 'Автоматически',
      body: 'GoToFlow самостоятельно подбирает структуру под загруженное фото, изображение или скриншот.',
    },
    {
      title: 'Строго по готовому сценарию',
      body: 'Если у вас уже есть логика публикации, GoToFlow помогает оформить фото-материал по заданной последовательности.',
    },
    {
      title: 'Любая идея',
      body: 'Начните с собственного фото и короткого описания задачи, если готовой структуры пока нет.',
    },
    {
      title: 'Разбор фото',
      body: 'Покажите деталь, процесс, ошибку или результат и добавьте пояснения на слайды.',
    },
    {
      title: 'До и после',
      body: 'Соберите серию с визуальным сравнением, комментариями и понятным финальным выводом.',
    },
    {
      title: 'Фото + экспертный текст',
      body: 'Используйте фото как визуальную основу, а GoToFlow поможет добавить тезисы, подсказки и CTA.',
    },
  ],
  choiceGuide: buildContractCarouselTypeGuide({
    title: {
      before: 'Когда фото становится ',
      accent: 'основой карусели',
      after: '',
    },
    description: 'Используйте фото, изображение или скриншот как отправную точку: покажите результат, процесс, ошибку, сравнение или пример и добавьте к нему понятные подписи по слайдам.',
  }),
  workflowHeading: {
    before: 'Как превратить ',
    accent: 'фото в карусель',
    after: '',
  },
  workflowIntro: 'Добавьте фото или изображение, задайте тему и цель, проверьте структуру слайдов, уточните текстовые акценты и скачайте готовую карусель после ручной проверки результата.',
  workflowSteps: [
    {
      title: 'Добавьте фото или изображение',
      body: 'Загрузите пользовательское фото, изображение или скриншот и коротко опишите задачу будущей карусели.',
    },
    {
      title: 'Выберите смысловой угол',
      body: 'GoToFlow помогает понять, что показать на слайдах: результат, процесс, ошибку, сравнение или пояснение.',
    },
    {
      title: 'Проверьте текстовые акценты',
      body: 'Отредактируйте заголовки, подписи и CTA, чтобы они не спорили с визуальным материалом.',
    },
    {
      title: 'Настройте визуальную подачу',
      body: 'Выберите формат, стиль, фон и композицию, сохраняя собственные материалы внутри карусели.',
    },
    {
      title: 'Скачайте готовые слайды',
      body: 'Проверьте итоговую серию и скачайте слайды для дальнейшей публикации вручную.',
    },
  ],
  readyExamplesIntro: {
    ...
    body: 'Фото может стать исходником для разбора, сравнения, инструкции, кейса, подборки или продуктового объяснения.',
  },
  examples: [
    { title: 'Разбор одного фото', body: 'Поясните детали, ошибки или преимущества на серии слайдов.' },
    { title: 'До и после', body: 'Покажите результат и объясните, что изменилось.' },
    { title: 'Фото процесса', body: 'Разложите этапы работы на понятные карточки.' },
    { title: 'Скриншот как кейс', body: 'Превратите скриншот в разбор с выводами.' },
    { title: 'Портфолио в карусель', body: 'Соберите несколько визуальных работ с подписями и CTA.' },
    { title: 'Фото + советы', body: 'Добавьте экспертные комментарии к визуальному примеру.' },
  ],
  useCasesHeading: {
    before: 'Когда нужен сценарий ',
    accent: 'фото в карусель',
    after: '',
  },
  useCases: [
    { title: 'Показать результат работы', body: 'Фото результата становится основой объясняющей или продающей карусели.' },
    { title: 'Разобрать ошибку', body: 'Скриншот или фото помогает показать проблему и решение.' },
    { title: 'Оформить портфолио', body: 'Несколько работ можно связать в одну последовательную историю.' },
    { title: 'Добавить экспертные подписи', body: 'Фото получает контекст: хук, тезисы и финальный CTA.' },
    { title: 'Собрать визуальный кейс', body: 'Фото и текст объединяются в понятную историю до/после.' },
    { title: 'Подготовить обучающий пост', body: 'Изображение становится иллюстрацией к шагам, советам или чек-листу.' },
  ],
  parameters: [
    { title: 'Фото как исходник', body: 'Используйте свои фото, изображения или скриншоты как основу для структуры, подписей и визуальной подачи.' },
    { title: 'Не про нарезку панорамы', body: 'Если вам нужен эффект единого полотна между слайдами, выбирайте отдельный сценарий бесшовной карусели.' },
    { title: 'Проверка перед публикацией', body: 'GoToFlow помогает создать и скачать слайды, а финальную публикацию в соцсети вы делаете вручную.' },
  ],
  productCapabilities: buildCanonicalProductCapabilities({
    heading: { before: 'Что можно сделать ', accent: 'с фото в GoToFlow', after: '' },
    introCopy: 'Добавьте фото, изображение или скриншот, соберите структуру слайдов, добавьте текстовые акценты, настройте визуальную подачу и скачайте результат после проверки.',
    highlightedCapabilities: ['image', 'screenshot', 'userPhoto', 'aiStructureText', 'textEditing', 'formats4511916'],
  }),
  readyCarouselShowcase: [
    {
      title: 'Визуальный разбор',
      body: 'Формат для ситуации, когда фото или скриншот помогает объяснить проблему, деталь или решение. Изображение служит опорой, а текст раскрывает смысл по слайдам.',
      image: '/images/niches/ru/content-ru-1.webp',
      width: 2048,
      height: 2048,
      type: 'Фото + пояснения',
      audience: 'Эксперты, SMM',
    },
    {
      title: 'Кейс до и после',
      body: 'Структура для сравнения результата: покажите исходную точку, изменения и выводы. Перед публикацией проверьте, что визуальная история читается без лишних обещаний.',
      image: '/images/niches/ru/content-ru-4.webp',
      width: 2048,
      height: 2048,
      type: 'Сравнение',
      audience: 'Бизнес, услуги',
    },
    {
      title: 'Портфолио с подписями',
      body: 'Серия работ или визуальных примеров может стать каруселью с короткими пояснениями, контекстом и финальным призывом к действию.',
      image: '/images/niches/ru/content-ru-9.webp',
      width: 2048,
      height: 2048,
      type: 'Портфолио',
      audience: 'Авторы, студии',
    },
    {
      title: 'Скриншот как пример',
      body: 'Скриншот интерфейса, переписки или результата можно разобрать по шагам: что важно заметить, почему это работает и что сделать дальше.',
      image: '/images/niches/ru/content-ru-10.webp',
      width: 2048,
      height: 2048,
      type: 'Разбор',
      audience: 'Обучение, продукт',
    },
    {
      title: 'Фото процесса',
      body: 'Если у вас есть визуальные этапы работы, их можно разложить в понятную последовательность с короткими подписями и финальным выводом.',
      image: '/images/niches/ru/content-ru-2.webp',
      width: 2048,
      height: 2048,
      type: 'Процесс',
      audience: 'Эксперты, услуги',
    },
    {
      title: 'Изображение с советами',
      body: 'Используйте визуальный пример как отправную точку для обучающей карусели: покажите деталь, добавьте объяснение и завершите понятным CTA.',
      image: '/images/niches/ru/content-ru-3.webp',
      width: 1792,
      height: 2400,
      type: 'Обучение',
      audience: 'Авторы, эксперты',
    },
  ],
  faqHeading: { before: 'Вопросы про ', accent: 'фото в карусель', after: '' },
  faq: [
    { question: 'Можно ли создать карусель из своих фото?', answer: 'Да. GoToFlow поддерживает сценарии с пользовательскими фото, изображениями и скриншотами как исходными материалами для будущей карусели.' },
    { question: 'Чем это отличается от бесшовной карусели?', answer: 'Здесь фото или изображение используется как материал для новой карусели. Бесшовная карусель нужна, когда нужен эффект единого визуального полотна между слайдами.' },
    { question: 'Это страница про нарезку панорамы на слайды?', answer: 'Нет. Здесь речь о создании новой карусели в GoToFlow. Техническая нарезка панорамы и подготовка бесшовного изображения — отдельная задача.' },
    { question: 'Можно ли добавить скриншот как исходник?', answer: 'Да. Скриншот можно использовать как визуальный источник для разбора, кейса, ошибки, примера интерфейса или обучающей карусели.' },
    { question: 'GoToFlow сам напишет текст для слайдов?', answer: 'GoToFlow помогает собрать структуру, текстовые акценты и CTA вокруг фото-материала. Перед скачиванием текст нужно проверить и при необходимости отредактировать.' },
    { question: 'Можно ли сделать Instagram-карусель из фото?', answer: 'Да. Фото можно использовать как основу Instagram-карусели: добавить подписи, порядок слайдов, визуальную подачу и CTA, а затем скачать результат для ручной публикации.' },
    { question: 'Можно ли использовать несколько фото?', answer: 'Да, можно работать с визуальными материалами для серии слайдов. Важно проверить, что итоговая логика карусели не перегружена и каждый слайд имеет одну задачу.' },
    { question: 'Какие форматы подходят для фото-карусели?', answer: 'Для Instagram чаще всего подходят 4:5 и 1:1; GoToFlow также поддерживает 9:16 для подходящих вертикальных сценариев.' },
    { question: 'Можно ли использовать фото из портфолио?', answer: 'Да. Фото работ, кейсы, визуальные примеры и скриншоты можно превратить в объясняющую или продающую карусель с подписями и CTA.' },
    { question: 'Будет ли GoToFlow публиковать карусель автоматически?', answer: 'Нет. GoToFlow помогает создать и скачать готовые слайды, но не обещает прямую автоматическую публикацию в соцсети.' },
    { question: 'Нужно ли уметь работать в Canva или Figma?', answer: 'Нет. GoToFlow помогает собрать карусель без ручной верстки каждого слайда, но итоговый результат все равно стоит проверить перед публикацией.' },
    { question: 'Можно ли совместить фото и готовый текст?', answer: 'Да. Вы можете использовать фото как визуальную основу, а готовый текст или заметки — как смысловой материал для подписей и структуры.' },
    { question: 'Можно ли сделать карусель из изображения бесплатно?', answer: 'Можно начать с бесплатного доступа без привязки карты. Конкретные лимиты и условия зависят от текущего тарифа в приложении GoToFlow.' },
    { question: 'Что проверить перед публикацией фото-карусели?', answer: 'Проверьте права на изображения, читаемость текста, цель каждого слайда, отсутствие лишних обещаний и корректность финального CTA.' },
    { question: 'Когда лучше выбрать шаблон, а не фото-сценарий?', answer: 'Если у вас нет визуального исходника и нужно сначала выбрать структуру публикации — чек-лист, кейс, гайд или анонс — лучше начать со страницы шаблонов.' },
  ],
  relatedHeading: 'Связанные сценарии',
  relatedCards: [
    { href: '/ru/generator-karuselej-instagram', title: 'Генератор каруселей для Instagram' },
    { href: '/ru/use-cases/tekst-v-karusel', title: 'Текст в карусель' },
    { href: '/ru/use-cases/besshovnaya-karusel-instagram', title: 'Бесшовная карусель' },
    { href: '/ru/templates/instagram-carousel', title: 'Шаблоны Instagram-каруселей' },
  ],
  visualProof: {
    eyebrow: 'Фото как основа',
    heading: { before: 'Используйте фото ', accent: 'для новой карусели', after: '' },
    title: 'Фото, изображение или скриншот помогают задать контекст',
    description: 'Добавьте визуальный материал, проверьте предложенную структуру, уточните подписи и скачайте готовые слайды после ручной проверки.',
  },
  finalCta: {
    heading: 'Создайте карусель из своих фото',
    description: 'Добавьте фото или скриншот, задайте смысловой угол и проверьте готовые слайды перед публикацией.',
    cta: 'Создать карусель из фото',
  },
  productTruth: {
    allowed: 'GoToFlow может использовать изображения, скриншоты и пользовательские фото как входной материал; продукт помогает собрать структуру, текстовые акценты, визуальную подачу, CTA и готовые слайды.',
    forbidden: 'Нельзя обещать прямой автопостинг, автоматическую нарезку панорамы, гарантированные охваты или обработку чужих изображений без прав.',
  },
};
...
const createValidationAwareFormats = (visibleItems) => {
  ...
  Object.defineProperty(formats, '__seoValidationItems', {
    configurable: true,
    enumerable: false,
...
const buildContractProductPage = ({
  ...
  return {
    ...
    readyCarouselShowcase: spec.readyCarouselShowcase || textToCarouselReadyShowcase.map((item, index) => ({
      ...item,
...
const seamlessInstagramCarouselDraftPage = {
  ...
  templateChoiceGuide: {
    ...
    items: [
      { id: 'source', task: 'Исходный материал', template: 'Тема, текст, ссылка, видео, вручную скопированный текст из PDF или голосовое', structure: 'добавьте контекст и задачу карусели' },
...
const rawSeoPages = [
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: ['Кейс в формате слайдов', 'Фреймворк или методика', 'Карусель из статьи или вручную скопированного текста из PDF'],
      },
      {
        id: 'workflow',
  ...
  },
  {
    ...
    productWorkflow: {
      ...
      stepOverrides: {
        ...
        structure: {
          ...
          description: 'Тема, ссылка, видео, вручную скопированный текст из PDF или голосовое. Структуру выберите сами или доверьте GoToFlow.',
        },
        textReview: {
    ...
    faq: [
      ...
      {
        question: 'Чем шаблоны отличаются от промптов для карусели?',
        answer: 'Шаблоны задают структуру и сценарий слайдов: чек-лист, кейс, ошибка, анонс или другой формат. Промпты и ChatGPT-команды остаются отдельным owner: они помогают сформулировать инструкцию для ИИ, но не заменяют страницу выбора шаблона.',
      },
    ],
    relatedSeoPages: [],
    relatedSeoPaths: ['/ru/use-cases/besshovnaya-karusel-instagram', '/ru/use-cases/tekst-v-karusel', '/ru/use-cases/foto-v-karusel'],
    relatedProductToolPaths: ['/ru/generator-karuselej-instagram'],
    contextualLinks: [
      {
...
const sanitizeWaveTwoVisibleText = (value) => {
  if (typeof value === 'string') {
    return value
      .replaceAll('подтверждённые Product Truth возможности', 'доступные настройки GoToFlow')
      .replaceAll('фактически поддерживаемые значения из Product Truth', 'поддерживаемые значения GoToFlow')
      .replaceAll('Product Truth', 'возможности GoToFlow')
      .replaceAll('canonical owner', 'основная страница')
      .replaceAll('owner', 'страница')
      .replaceAll('intent', 'задача')
      .replaceAll('Contract', 'описание')
      .replaceAll('evidence', 'данные')
      .replaceAll('noindex draft', 'черновик')
      .replaceAll('review status', 'статус проверки')
      .replaceAll('подтверждено registry', 'подтверждено GoToFlow');
  }

  if (Array.isArray(value)) {
    return value.map(sanitizeWaveTwoVisibleText);
  }

  if (value && typeof value === 'object') {
    return Object.fromEntries(
      Object.entries(value).map(([key, nestedValue]) => [key, sanitizeWaveTwoVisibleText(nestedValue)])
    );
  }
...
const productionWaveTwoExpansions = {
  '/ru/tools/luchshie-servisy-dlya-karuseley': {
    decision: 'MERGE_EXPAND',
    packetIds: ['PKT_0089'],
    queryClusters: ['сервис или нейросеть для создания карусели'],
    quickAnswer: {
      title: 'Как выбрать сервис для создания каруселей',
      body: 'Смотрите, умеет ли инструмент принимать тему, готовый текст или ссылку, собирать структуру слайдов, давать редактор перед скачиванием и поддерживать нужные размеры. GoToFlow закрывает этот сценарий в одном окне: от идеи и текста до готовых изображений для ручной публикации.',
    },
    faqReplacement: {
      question: 'Как выбрать сервис или нейросеть для каруселей?',
      answer: 'Проверьте, есть ли ввод темы или исходного материала, генерация структуры, редактор текста, шаблоны, форматы 4:5, 1:1 и 9:16, а также скачивание готовых слайдов. GoToFlow объединяет эти шаги в одном рабочем процессе.',
    },
    relatedCards: [
      { href: '/ru/alternatives/canva-dlya-karuseley', title: 'Аналог Canva для каруселей', type: 'seo_page' },
  ...
  '/ru/alternatives/canva-dlya-karuseley': {
    decision: 'EXPAND',
    packetIds: ['PKT_0584'],
    queryClusters: ['нейросеть для создания карусели с помощью Canva'],
    quickAnswer: {
      title: 'Когда GoToFlow удобнее ручной сборки в Canva',
      body: 'GoToFlow подходит, когда нужно быстро получить структуру, тексты и оформленные слайды из темы или исходного материала. Canva остается сильным визуальным редактором, но в GoToFlow меньше ручной верстки: сначала собирается смысл карусели, затем вы проверяете текст, стиль и экспортируете результат.',
    },
    faqReplacement: {
      question: 'Можно ли использовать GoToFlow вместо Canva для каруселей?',
      answer: 'Да, если вам важна не ручная верстка каждого слайда, а быстрый путь от темы или текста к готовой последовательности карточек. Финальный текст, стиль и порядок слайдов все равно стоит проверить перед публикацией.',
    },
    relatedCards: [
  ...
  '/ru/alternatives/chatgpt-dlya-karuseley': {
    decision: 'EXPAND',
    packetIds: ['PKT_0622'],
    queryClusters: ['создать карусель с помощью ChatGPT'],
    quickAnswer: {
      title: 'Чем GoToFlow отличается от обычного чата',
      body: 'ChatGPT может помочь с идеями и текстом, но после этого обычно нужно переносить материал в редактор и вручную раскладывать его по слайдам. GoToFlow делает карусель как продуктовый процесс: собирает структуру, распределяет текст, показывает визуальный результат и дает скачать слайды.',
    },
    faqReplacement: {
      question: 'Можно ли сделать карусель из идеи, которую я обычно написал бы в ChatGPT?',
      answer: 'Да. В GoToFlow можно начать с простой идеи или черновика: система поможет превратить ее в структуру слайдов, текстовые акценты и визуальную карусель без отдельного переноса в графический редактор.',
    },
    relatedCards: [
      { href: '/ru/tools/luchshie-servisy-dlya-karuseley', title: 'Сервисы для создания каруселей', type: 'seo_page' },
      { href: '/ru/alternatives/canva-dlya-karuseley', title: 'Аналог Canva для каруселей', type: 'seo_page' },
  ...
  '/ru/use-cases/video-v-karusel': {
    decision: 'MERGE_EXPAND',
    packetIds: ['PKT_0613', 'PKT_0577'],
    queryClusters: ['создать карусель из видео', 'нейросеть для создания карусели из видео для Instagram'],
    faqReplacement: {
      question: 'Можно ли сделать карусель из YouTube-видео для Instagram?',
  ...
  '/ru/use-cases/carousels-for-smm': {
    decision: 'EXPAND',
    packetIds: ['PKT_0608'],
    queryClusters: ['создать карусель для SMM и маркетолога'],
    quickAnswer: {
      title: 'Как SMM-специалисту быстрее собирать карусели',
      body: 'Добавьте бриф, тему клиента или ссылку на исходник. GoToFlow поможет получить структуру, тексты по слайдам и визуальный черновик, который можно отредактировать под голос бренда и скачать для согласования или публикации.',
    },
    faqReplacement: {
      question: 'Подходит ли GoToFlow для нескольких клиентских проектов?',
  ...
  '/ru/use-cases/carousels-for-beauty': {
    decision: 'EXPAND',
    packetIds: ['PKT_0601'],
    queryClusters: ['создать Instagram-карусель для бьюти'],
    quickAnswer: {
      title: 'Как бьюти-мастеру собрать карусель',
      body: 'Добавьте тему процедуры, прайс, советы по уходу или фото работ. GoToFlow поможет разложить материал по слайдам, добавить понятные подписи и подготовить аккуратную карусель для ручной публикации.',
    },
    faqReplacement: {
      question: 'Можно ли сделать карусель из фото работ и прайса?',
  ...
  '/ru/use-cases/carousels-for-experts': {
    decision: 'EXPAND',
    packetIds: ['PKT_0427'],
    queryClusters: ['создать карусель для эксперта и блогера'],
    quickAnswer: {
      title: 'Как превратить экспертность в карусель',
      body: 'Вставьте статью, тезисы консультации, заметки или идею поста. GoToFlow помогает выделить главную мысль, собрать последовательность слайдов, сохранить ваш тон в редакторе и скачать готовую карусель.',
    },
    faqReplacement: {
      question: 'Можно ли превратить консультацию или статью в карусель?',
  ...
  '/ru/use-cases/social-content-for-business': {
    decision: 'EXPAND',
    packetIds: ['PKT_0240'],
    queryClusters: ['сервис или нейросеть для создания контента для бизнеса'],
    quickAnswer: {
      title: 'Как бизнесу быстрее готовить визуальный контент',
      body: 'Опишите продукт, услугу, акцию или кейс. GoToFlow помогает собрать структуру публикации, текстовые акценты, карточки и CTA, чтобы команда могла проверить материал и скачать готовые слайды для своих каналов.',
    },
    faqReplacement: {
      question: 'Можно ли подготовить карусель для товара или услуги?',
...
const applyProductionWaveTwoExpansion = (page) => {
  const expansion = productionWaveTwoExpansions[page.path];
  ...
  const enhancedPage = {
    ...
    notes: [
      ...(page.notes || []),
      `Production Wave 2 ${expansion.decision}: ${expansion.packetIds.join(', ')}`,
      `Wave 2 query clusters: ${expansion.queryClusters.join('; ')}`,
    ],
    lastUpdated: '2026-07-22',
  };

  if (expansion.faqReplacement && Array.isArray(page.faq) && page.faq.length > 0) {
    enhancedPage.faq = [
      ...page.faq.slice(0, -1),
      expansion.faqReplacement,
    ];
  }

  for (const field of visibleWaveTwoFields) {
    if (enhancedPage[field]) {
      enhancedPage[field] = sanitizeWaveTwoVisibleText(enhancedPage[field]);
    }
  }
...
export const seoPages = seoPagesSource.map(applyProductionWaveTwoExpansion).map(normalizeLegacySeoPage);
