...
**Route:** `/ru/reviews/ai-carousel-generators`
**Target System:** Carousel Page Production System (Freeze v1.1)
**Primary Intent:** COMMERCIAL / REVIEWS

---

> [!CAUTION]
> **SYSTEM BLOCKER:** BLOCKER: Недостаточно чистого review-спроса (в Demand Master есть только один шумный запрос про отзывы). Нельзя строить продуктовую страницу на вымышленных отзывах конкурентов без источника данных.
...
- **Исключенный шум:** Случайные мусорные запросы, не имеющие отношения к Обзор и отзывы на AI-генераторы каруселей.
- **URL-origin signals:** Из `gotoflow_top_100_seo_candidates.md`.

---

## 2. Intent Ownership
- **Primary intent:** COMMERCIAL / REVIEWS — Отзывы на AI-генераторы каруселей | GoToFlow.
...
## 3. Final URL
- **Final URL:** `/ru/reviews/ai-carousel-generators`
- **Slug:** `ai-carousel-generators`
- **Аргументация:** URL отражает COMMERCIAL / REVIEWS интент и соответствует архитектуре. Не скопирован слепо из одного запроса.

---

## 4. Page Family
- **Selected family:** `reviews`
...
## 5. Metadata
- **SEO Title:** Отзывы на AI-генераторы каруселей | GoToFlow
- **Meta Description:** Честные отзывы и сравнение ИИ-инструментов для создания контента и каруселей в соцсетях.
- **H1:** Обзор и отзывы на AI-генераторы каруселей
- **Canonical:** `/ru/reviews/ai-carousel-generators`
...
- **Eyebrow:** Отзывы
- **H1:** Обзор и отзывы на AI-генераторы каруселей
- **Description:** Честные отзывы и сравнение ИИ-инструментов для создания контента и каруселей в соцсетях.
...
- **Body:** Вставьте текст, идею или ссылку. ИИ проанализирует контекст и соберет готовую карусель, адаптированную под тематику Обзор и отзывы на AI-генераторы каруселей.
...
- **Карточки 4-6 (Page-specific):** Адаптированы под COMMERCIAL / REVIEWS.
