...
**Route:** `/ru/tools/razmer-i-format-karuseli-v-instagram`
...
> [!CAUTION]
> **SYSTEM BLOCKER:** BLOCKER: Отдельного инструмента-калькулятора, кроппера или standalone-конвертера форматов нет. Размер меняется только как настройка внутри общего редактора карусели. Tool-intent не может быть реализован как самостоятельная продуктовая страница.
...
- **Исключенный шум:** Случайные мусорные запросы, не имеющие отношения к Конвертер размера и формата карусели.
- **URL-origin signals:** Из `gotoflow_top_100_seo_candidates.md`.

---

## 2. Intent Ownership
- **Primary intent:** TOOL — Инструмент для изменения размера карусели Instagram | GoToFlow.
...
## 3. Final URL
- **Final URL:** `/ru/tools/razmer-i-format-karuseli-v-instagram`
...
## 5. Metadata
- **SEO Title:** Инструмент для изменения размера карусели Instagram | GoToFlow
- **Meta Description:** Настройте правильный размер (4:5, 1:1, 9:16) для карусели в Instagram перед публикацией.
- **H1:** Конвертер размера и формата карусели
- **Canonical:** `/ru/tools/razmer-i-format-karuseli-v-instagram`
...
- **Eyebrow:** Инструмент
- **H1:** Конвертер размера и формата карусели
- **Description:** Настройте правильный размер (4:5, 1:1, 9:16) для карусели в Instagram перед публикацией.
...
- **Body:** Вставьте текст, идею или ссылку. ИИ проанализирует контекст и соберет готовую карусель, адаптированную под тематику Конвертер размера и формата карусели.
