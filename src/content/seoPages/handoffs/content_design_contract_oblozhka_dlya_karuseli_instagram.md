...
**Route:** `/ru/tools/oblozhka-dlya-karuseli-instagram`
...
> [!CAUTION]
> **SYSTEM BLOCKER:** VISUAL BLOCKER: Нет отдельного независимого генератора обложек. Требуется подтверждение возможности генерации ТОЛЬКО первого слайда (обложки) в рамках GoToFlow, либо инструмент должен быть заявлен как часть общего флоу.
...
- **Исключенный шум:** Случайные мусорные запросы, не имеющие отношения к Генератор обложек для Instagram каруселей.
- **URL-origin signals:** Из `gotoflow_top_100_seo_candidates.md`.

---

## 2. Intent Ownership
- **Primary intent:** TOOL — Создать обложку для карусели Instagram онлайн | GoToFlow.
...
## 3. Final URL
- **Final URL:** `/ru/tools/oblozhka-dlya-karuseli-instagram`
- **Slug:** `oblozhka-dlya-karuseli-instagram`
- **Аргументация:** URL отражает TOOL интент и соответствует архитектуре. Не скопирован слепо из одного запроса.
...
## 5. Metadata
- **SEO Title:** Создать обложку для карусели Instagram онлайн | GoToFlow
- **Meta Description:** Создавайте цепляющие обложки для каруселей в Instagram. ИИ подберет заголовок и сгенерирует первый слайд, который остановит скроллинг.
- **H1:** Генератор обложек для Instagram каруселей
- **Canonical:** `/ru/tools/oblozhka-dlya-karuseli-instagram`

---

## 6. Hero
- **Eyebrow:** Обложки для каруселей
- **H1:** Генератор обложек для Instagram каруселей
- **Description:** Создавайте цепляющие обложки для каруселей в Instagram. ИИ подберет заголовок и сгенерирует первый слайд, который остановит скроллинг.
...
- **Body:** Вставьте текст, идею или ссылку. ИИ проанализирует контекст и соберет готовую карусель, адаптированную под тематику Генератор обложек для Instagram каруселей.
...
- **Карточки 4-6 (Page-specific):** Адаптированы под TOOL.
