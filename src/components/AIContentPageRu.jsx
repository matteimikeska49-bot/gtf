...
/* ── Problem (RU) ── */
const problemCards = [
  { title: "Тратите 3 часа → одна контент", text: "Написать хуки, придумать структуру слайдов и подготовить текст занимает вечность — даже если ИИ выдаёт черновик, его нужно переписывать." },
