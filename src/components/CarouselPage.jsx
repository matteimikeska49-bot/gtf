...
export const CarouselPage = () => (
  <MainLayout>
    ...
    <section className="py-6 px-6 bg-[#050505] relative z-10 w-full flex flex-col items-center gap-6">
      ...
      <div className="max-w-3xl w-full p-6 md:p-8 rounded-2xl border border-white/[0.05] bg-white/[0.02]">
        <h3 className="text-white font-medium mb-4 text-base md:text-lg">Related guides & prompts:</h3>
        <ul className="space-y-3 text-sm md:text-base">
            <li className="flex items-center gap-2"><span className="text-pink-500">•</span><Link to="/blog/instagram-carousel-prompts" className="text-zinc-300 hover:text-pink-400 transition-colors underline underline-offset-4 decoration-white/10 hover:decoration-pink-400/50">Instagram carousel prompts</Link></li>
            <li className="flex items-center gap-2"><span className="text-pink-500">•</span><Link to="/blog/linkedin-carousel-prompts" className="text-zinc-300 hover:text-pink-400 transition-colors underline underline-offset-4 decoration-white/10 hover:decoration-pink-400/50">LinkedIn carousel prompts</Link></li>
            <li className="flex items-center gap-2"><span className="text-pink-500">•</span><Link to="/blog/best-ai-carousel-generators" className="text-zinc-300 hover:text-pink-400 transition-colors underline underline-offset-4 decoration-white/10 hover:decoration-pink-400/50">Best AI carousel generators</Link></li>
        </ul>
      </div>
    </section>
    <TestimonialsSection />
