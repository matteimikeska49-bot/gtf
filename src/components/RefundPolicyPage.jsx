...
const RefundSEOHead = () => {
  useEffect(() => {
    ...
    setLink('alternate', 'https://gotoflow.io/refund-policy', { hreflang: 'en' });
    setLink('alternate', 'https://gotoflow.io/refund-policy', { hreflang: 'x-default' });
    ...
    <MainLayout>
      ...
      <main className="pt-32 pb-20 px-6 relative z-10 w-full bg-[#050505] flex-1">
        <div className="max-w-3xl mx-auto">
          <div className="mb-12">
            <h1 className="text-3xl md:text-4xl font-bold text-white tracking-tight mb-4">{t('legal.refund.title')}</h1>
