...
export const SEOHead = () => {
  useEffect(() => {
    document.title = 'AI Instagram Post Generator | Create Posts Fast';
    ...
    setLink('canonical', 'https://gotoflow.io/ai-post-maker');
    setLink('alternate', 'https://gotoflow.io/ai-post-maker', { hreflang: 'en' });
    setLink('alternate', 'https://gotoflow.io/ru/generator-postov-instagram', { hreflang: 'ru' });
    return () => { document.title = 'AI Content Generator for Social Media — Create Posts, Posts & Reels Fast | GoToFlow'; };
  }, []);
  return null;
};
...
/* ── Showcase (post-only) ── */
const postCards = [
  { id: 2, format: 'square', likes: '8.1K', views: '20K', label: 'Marketing post', image: '/images/niches/image_2.png.jpg' },
  { id: 3, format: 'square', likes: '1.8K', views: '5K', label: 'Promotion post', image: '/images/niches/image_3.png.jpg' },
  { id: 5, format: 'square', likes: '6.7K', views: '18K', label: 'Beauty post', image: '/images/niches/image_5.png.jpg' },
  { id: 6, format: 'square', likes: '5.9K', views: '14K', label: 'Fitness post', image: '/images/niches/image_6.png.jpg' },
  { id: 7, format: 'square', likes: '2.4K', views: '7K', label: 'Educational post', image: '/images/niches/image_7.png.jpg' },
  { id: 8, format: 'square', likes: '980', views: '3.2K', label: 'Travel post', image: '/images/niches/image_8.png.jpg' },
  { id: 9, format: 'square', likes: '10K', views: '25K', label: 'Lifestyle post', image: '/images/niches/image_9.png.jpg' },
  { id: 10, format: 'square', likes: '7.2K', views: '15K', label: 'IT Services post', image: '/images/niches/image_10.png' },
];
    ...
    <div className="max-w-7xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center">
      <div className="flex flex-col">
        <motion.div initial={{opacity:0,x: isMobile ? 0 : -40, y: isMobile ? 24 : 0}} whileInView={{opacity:1,x:0,y:0}} viewport={{once:true}} transition={{duration: isMobile ? 0.6 : 0.8}}>
          ...
          <p className="text-base md:text-lg text-zinc-400 font-medium leading-relaxed text-balance mb-12">While Canva gives you a blank canvas and a template, GoToFlow writes your post content — hooks, slide copy, structure — using AI trained on top-performing social media posts.</p>
        </motion.div>
...
const faqItems = [
  ...
  { q: 'Can AI create Instagram posts?', a: 'Yes. GoToFlow generates post content optimized for Instagram, LinkedIn, and Telegram. The AI writes hook-led copy, structures the slides logically, and ensures each post is built to drive saves and shares.' },
  { q: 'Is GoToFlow better than Canva for posts?', a: 'They solve different problems. Canva helps you design; GoToFlow writes the content. GoToFlow generates the ideas, hooks, and copy — then you can use any design tool to format it. Many users combine both.' },
