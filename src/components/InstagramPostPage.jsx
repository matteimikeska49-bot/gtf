...
export const SEOHead = () => {
  useEffect(() => {
    document.title = 'AI Instagram Post Generator | GoToFlow';
    ...
    <div className="max-w-7xl mx-auto flex flex-col items-center text-center relative z-10 w-full">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="mt-4 md:mt-0 mb-8">
        <div className="inline-flex items-center gap-2.5 rounded-full border border-white/10 bg-white/5 px-4 py-1.5 backdrop-blur-sm">
          ...
          <span className="text-sm text-zinc-300 whitespace-nowrap">AI Instagram Post Generator for creators and teams</span>
        </div>
      </motion.div>
      <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: isMobile ? 0.6 : 0.8, delay: 0.1 }} className="max-w-3xl mx-auto w-full">
        <h1 className="text-[1.6rem] sm:text-[2rem] md:text-[2.6rem] lg:text-[3.1rem] font-bold text-white tracking-[-0.035em] leading-[1.12] mb-8 text-balance">
          AI Instagram Post Generator —<br className="hidden md:block" /> Create Posts in<br className="hidden md:block" /> <span className="text-gradient-brand">60 Seconds</span>
        </h1>
      </motion.div>
      <motion.p initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: isMobile ? 0.6 : 0.8, delay: 0.2 }} className="text-sm md:text-[0.92rem] text-zinc-500 max-w-lg mx-auto mb-12 leading-[1.75] font-medium text-balance">
        Generate a complete Instagram or LinkedIn post in seconds — from idea to final slides.<br className="hidden md:block" /> No design skills, no team, no templates.
      </motion.p>
...
export const PostSEOBlock = () => (
  <section className="py-20 md:py-28 px-6 relative z-10 w-full bg-[#050505]">
    <div className="max-w-3xl mx-auto">
      <h2 className="text-2xl md:text-3xl font-bold text-white tracking-tight mb-6">What is an AI Instagram Post Generator?</h2>
      <div className="text-zinc-400 leading-relaxed space-y-4 text-base">
        <p>An <strong className="text-zinc-200">AI post generator</strong> is a tool that uses artificial intelligence to automatically generate multi-slide social media posts — commonly known as posts — for platforms like Instagram, LinkedIn, and Telegram. Instead of writing each slide manually, you provide a topic or idea, and the AI produces a structured, hook-led post ready to publish.</p>
        <p>GoToFlow's <strong className="text-zinc-200">Instagram post</strong> generator goes beyond simple templates. It understands context, applies proven content frameworks, and crafts each slide with a clear purpose — from a scroll-stopping opener to a closing call-to-action.</p>
...
const faqItems = [
  ...
  { q: 'Can AI create Instagram posts?', a: 'Yes. GoToFlow generates post content optimized for Instagram, LinkedIn, and Telegram. The AI builds the hook, structure, copy, visual direction, and CTA so the result is a complete content workflow.' },
