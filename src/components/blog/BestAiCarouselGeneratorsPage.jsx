...
const ArticleBody = () => (
  <article className="pt-4 pb-8 px-4 sm:px-6 relative z-10 w-full bg-[#050505] overflow-hidden">
    ...
    <div className="bg-white/[0.015] border border-white/[0.06] rounded-3xl px-5 sm:px-8 md:px-12 py-8 md:py-14">
      ...
      <ul className="space-y-3 mb-5">
        <li className="flex items-start gap-3.5 text-zinc-300 text-[15px] md:text-base leading-[1.7]"><span className="mt-2 w-1.5 h-1.5 rounded-full bg-pink-400/80 shrink-0" /><span><strong>Sequence:</strong> each slide should make the next slide feel natural.</span></li>
        <li className="flex items-start gap-3.5 text-zinc-300 text-[15px] md:text-base leading-[1.7]"><span className="mt-2 w-1.5 h-1.5 rounded-full bg-pink-400/80 shrink-0" /><span><strong>Pacing:</strong> the reader should not feel overloaded.</span></li>
        <li className="flex items-start gap-3.5 text-zinc-300 text-[15px] md:text-base leading-[1.7]"><span className="mt-2 w-1.5 h-1.5 rounded-full bg-pink-400/80 shrink-0" /><span><strong>Slide logic:</strong> every slide should have a job.</span></li>
        <li className="flex items-start gap-3.5 text-zinc-300 text-[15px] md:text-base leading-[1.7]"><span className="mt-2 w-1.5 h-1.5 rounded-full bg-pink-400/80 shrink-0" /><span><strong>Scannability:</strong> the copy should be easy to read on mobile.</span></li>
        <li className="flex items-start gap-3.5 text-zinc-300 text-[15px] md:text-base leading-[1.7]"><span className="mt-2 w-1.5 h-1.5 rounded-full bg-pink-400/80 shrink-0" /><span><strong>Visual direction:</strong> the design style should support the message.</span></li>
        <li className="flex items-start gap-3.5 text-zinc-300 text-[15px] md:text-base leading-[1.7]"><span className="mt-2 w-1.5 h-1.5 rounded-full bg-pink-400/80 shrink-0" /><span><strong>A clear CTA:</strong> the reader should know what to do next.</span></li>
      </ul>
      <p className="text-zinc-300 text-[15px] md:text-base leading-[1.85] mb-14 md:mb-16">
      ...
      <ul className="space-y-3 mb-5">
        ...
        <li className="flex items-start gap-3.5 text-zinc-300 text-[15px] md:text-base leading-[1.7]"><span className="mt-2 w-1.5 h-1.5 rounded-full bg-pink-400/80 shrink-0" /><span>If you need <strong>LinkedIn scheduling</strong>, use <strong>Taplio</strong> or <strong>ContentIn</strong>.</span></li>
        <li className="flex items-start gap-3.5 text-zinc-300 text-[15px] md:text-base leading-[1.7]"><span className="mt-2 w-1.5 h-1.5 rounded-full bg-pink-400/80 shrink-0" /><span>If you need <strong>brand voice workflows</strong>, use <strong>Jasper</strong> or <strong>Copy.ai</strong>.</span></li>
        <li className="flex items-start gap-3.5 text-zinc-300 text-[15px] md:text-base leading-[1.7]"><span className="mt-2 w-1.5 h-1.5 rounded-full bg-pink-400/80 shrink-0" /><span>If you need <strong>custom visual systems</strong>, use <strong>Figma</strong>.</span></li>
      </ul>
      <p className="text-zinc-300 text-[15px] md:text-base leading-[1.85] mb-14 md:mb-16">
