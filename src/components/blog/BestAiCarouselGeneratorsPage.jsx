...
const ArticleBody = () => (
  <article className="pt-4 pb-8 px-6 relative z-10 w-full bg-[#050505] overflow-hidden">
    ...
    <div className="max-w-3xl mx-auto relative z-10">
      ...
      <p className="text-zinc-300 text-[15px] md:text-base leading-[1.85] mb-5">
        LinkedIn usually needs a more professional, idea-led structure. Instagram often needs a more visual, simple, and aesthetic format.
      </p>
      <p className="text-zinc-300 text-[15px] md:text-base leading-[1.85] mb-8">
      ...
      <p className="text-zinc-300 text-[15px] md:text-base leading-[1.85] mb-8">
        These tools are useful if your main need is not just carousel generation, but the entire LinkedIn publishing workflow.
      </p>
