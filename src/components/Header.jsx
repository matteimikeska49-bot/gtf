...
export const Logo = () => {
  ...
  return (
    <Link to={logoHref} className="flex min-h-11 min-w-11 items-center gap-2.5 cursor-pointer transition-transform hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pink-400/60">
      ...
      <span className="text-xl font-extrabold tracking-tight text-white max-[380px]:hidden">GoToFlow</span>
    </Link>
  );
};
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 h-16 flex items-center justify-between gap-2 sm:gap-4">
        ...
        <div className="flex min-w-0 items-center gap-2 sm:gap-3">
              ...
              {['EN', 'RU'].map((l) => {
                ...
                return (
                  <button
                    ...
                    disabled={isDisabled}
                    className={`inline-flex min-h-11 min-w-11 items-center justify-center rounded-full px-3 py-2 text-xs font-bold tracking-wider transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pink-400/60 ${
                      isActive
          ...
          <button 
            ...
            className="hidden min-h-11 md:flex items-center gap-2 px-5 py-2.5 rounded-full font-bold text-sm text-white bg-gradient-to-r from-pink-500 to-orange-500 shadow-[0_0_20px_rgba(236,72,153,0.3)] hover:shadow-[0_0_35px_rgba(236,72,153,0.5)] hover:scale-105 active:scale-[0.98] transition-all duration-300 border border-pink-400/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pink-400/60">
            {t('common.startFree')}
          ...
          <button 
            onClick={() => window.location.href = getAppUrlWithRef('https://app.gotoflow.io')}
            className="md:hidden flex min-h-11 items-center gap-1.5 rounded-full bg-gradient-to-r from-pink-500 to-orange-500 px-3 py-2 text-xs font-bold text-white shadow-[0_0_15px_rgba(236,72,153,0.3)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pink-400/60 max-[340px]:px-2.5">
            {t('common.start')}
          </button>
        </div>
      </div>
