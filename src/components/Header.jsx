...
export const Logo = () => {
  ...
  return (
    <Link to={logoHref} className="flex items-center gap-2.5 cursor-pointer transition-transform hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pink-400/60">
...
export const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 border-b border-white/[0.05] bg-[#050505]/95">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between gap-4 max-[360px]:gap-2 max-[360px]:px-3">
        <Logo />
        ...
        <div className="flex items-center gap-3 max-[360px]:gap-2">
              ...
              {['EN', 'RU'].map((l) => {
                ...
                return (
                  <button
                    ...
                    disabled={isDisabled}
                    className={`px-3 py-1 rounded-full text-xs font-bold tracking-wider transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pink-400/60 ${
                      isActive
          ...
          <button 
            onClick={() => window.location.href = getAppUrlWithRef('https://app.gotoflow.io')}
            className="md:hidden flex items-center gap-1.5 px-4 py-2 rounded-full font-bold text-xs text-white bg-gradient-to-r from-pink-500 to-orange-500 shadow-[0_0_15px_rgba(236,72,153,0.3)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pink-400/60 max-[340px]:px-3">
            {t('common.start')}
          </button>
        </div>
      </div>
