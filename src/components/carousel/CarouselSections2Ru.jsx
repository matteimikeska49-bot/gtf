  ...
  <section className="py-20 md:py-28 px-6 relative z-10 w-full bg-[#050505]">
    <div className="max-w-3xl mx-auto">
      ...
      <div className="text-zinc-400 leading-relaxed space-y-4 text-base">
        <p>Генератор каруселей с ИИ — это инструмент, который автоматически создает <strong className="text-zinc-200">карусель Instagram</strong> и других соцсетей. Вместо того чтобы писать каждый слайд вручную, вы просто вводите тему или идею, и ИИ выдает структурированную карусель с сильным хуком, готовую к публикации.</p>
        <p>Наш <strong className="text-zinc-200">AI генератор каруселей</strong> работает не как обычные шаблоны. ИИ анализирует контекст, применяет проверенные контентные фреймворки и создает каждый слайд с четкой целью — от цепляющего заголовка до призыва к действию (CTA) в конце.</p>
        <p>Используя <strong className="text-zinc-200">генератор каруселей для Инстаграм</strong>, вы ускоряете производство контента, получаете стабильное качество и возможность тестировать разные подходы. Будь вы эксперт или фаундер, ИИ забирает на себя самую сложную часть работы.</p>
      </div>
    </div>
  </section>
);
