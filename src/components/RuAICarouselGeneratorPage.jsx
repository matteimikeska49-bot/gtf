...
/* ── Problem ── */
const problemCards = [
  { title: "Тратите часы на один пост", text: "Написание хуков, структура и формат отнимают время, даже с ИИ-черновиками, которые нужно переписывать." },
...
const diffPoints = [
  ...
  { icon: Zap, title: 'Готовая карусель, а не черновик', desc: 'Получите готовые слайды, а не просто блок текста, который нужно переносить в редактор.' },
];
